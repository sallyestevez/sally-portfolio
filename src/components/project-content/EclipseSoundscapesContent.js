      ...
      <section>
        <div className="ProjectContent">
          ...
          <h2 className="CaseStudyText">Full case study coming soon!</h2>
            ...
            <p>
            The Eclipse Soundscapes Project aims to provide an accessible multi-sensory experience, 
            enabling individuals, especially those who are visually impaired or unable to witness 
            the eclipse firsthand, to experience the event.
            </p>
          </div>
          ...
          <div className="ProjectDiv ProjectObservations">
            ...
            <p>We conducted a thorough assessment of the website to identify usability issues and areas 
              for enhancement, focusing on how users interact with the interface and their overall experience.</p>
            <h2>Loading</h2>
            <p>✷ Long load time</p>
            <h2>Navigation</h2>
            <p>✷ The directory is only at the top</p>
            <p>✷ "Back to top" is at the bottom of the section and still cuts off top</p>
            <p>✷ Too much scrolling</p>
            <p>✷ Contacts, Instagram, and Twitter are cut off by moon</p>
            <p>✷ No link is attached to the "here" in the opening paragraph</p>
            <h2>Images</h2>
            <p>✷ Very small</p>
            <p>✷ No consistent sizes</p>
            <h2>Text</h2>
            <p>✷ Everything uses the same font</p>
            <p>✷ Text is the entire width of the page</p>
            <h2>Sections</h2>
            <p>✷ Not enough space in between</p>
            <p>✷ Too much text</p>
            <p>✷ No breaks</p>
            <h2>Background</h2>
            <p>✷ Night mode (moon icon) doesn't really do anything</p>
            <h2>Content</h2>
            <p>✷ Zooming in makes everything much larger (edited)</p>
            <p>✷ Download on Apple App Store and Google Play are on separate lines</p>
            <p>✷ Looks better on mobile</p>
            <p>✷ Can't view Field Researcher page in Spanish</p>
          </div>
          <div className="ProjectDiv ProjectResearchPlan">
            <div className="ProjectPageSubtitle">User Research & Synthesis</div>
            <p>To understand the needs of our target demographic, we conducted a total of 12 in-depth interviews 
          ...
          <div className="ProjectDiv ProjectLoFi">
            ...
            <h2>Wireframes</h2>
            <p>
            Based on what we learned from the user interviews and user testing, we created low-fidelity 
            wireframes, dividing sections of the page for collaborative design and feedback.
            </p>
            <h2>Design Solutions</h2>
            <p>Our redesign solutions included:</p>
            <p>Color Palette - implementing a lighter, more inviting color scheme</p>
          ...
          <div className="ProjectDiv ProjectHiFi">
            ...
            <p>Utilizing our research findings, we developed a high-fidelity prototype that incorporates user 
              feedback and design improvements, enhancing overall usability for the target audience.
            </p>
          </div>
          ...
          <div className="ProjectDiv ProjectTakeaways">
            ...
            <p>To ensure the redesign effectively meets user needs, we have outlined the following steps for moving forward:</p>
            ...
            <p>To effectively enhance the user experience and accessibility of the website, we recommend implemented the following 
              phased approach:</p>
            <h2>Now</h2>
            <p>✷ <strong>Enhance Navigation:</strong> Ensure navigation is accessible on all parts of the page</p>
            <p>✷ <strong>Text Buffer Zone:</strong> Add a buffer zone around text to improve readability</p>
            <h2>Next</h2>
            <p>✷ <strong>Light Mode:</strong> Implement a light mode option for better visual comfort</p>
            <p>✷ <strong>Consistent Image Sizes:</strong> Standardize image sizes throughout the size</p>
            <p>✷ <strong>Text Structure:</strong> Break up large sections of text for improved readability</p>
            <h2>Later</h2>
            <p>✷ <strong>Video Guides:</strong> Record and integrate video guides/walkthroughs for user support</p>
            <p>✷ <strong>Additional Visuals:</strong> Include more visuals to enrich the user experience</p>
            <p>✷ <strong>Text-to-Speech:</strong> Add text to speech functionality for accessibility</p>
            <p>✷ <strong>Language Options:</strong> Incorporate options for different languages to reach a broader audience</p>
          </div>
        </div>
      </section>
    </div>
