      ...
      <section>
        <div className="ProjectContent">
          ...
          <div className="ProjectDiv ProjectOverview">
            ...
            <p>
              Discord is a social platform for text, voice, and video chat with
              friends and communities. While the platform offers a range of
              features and customization options, many of its more advanced
              features are restricted to Nitro, Discord's subscription service.
              Nitro subscribers are granted enhanced profile customization
              features and the ability to upload larger files.
            </p>
            <h2>What is the problem?</h2>
            <p>
              For non-subscribers, file uploads are limited to 8 MB, which makes
              it hard for users to share larger files, such as images, videos,
              or documents. This limitation can disrupt the user experience,
              often forcing users to seek workarounds, such as using external
          ...
          <div className="ProjectDiv ProjectProblem">
            ...
            <h2>
              How can we make file sharing easier for those who want to use
              Discord without an added cost?
            </h2>
          </div>
          <div className="ProjectDiv ProjectResearchPlan">
            ...
            <p>
              I interviewed 5 Discord users. I asked them a total of 16
              questions, including:
            </p>
            ...
            <p>
              <strong>5 out of 5</strong> users use Discord to communicate with
              friends
            </p>
            <p>
            ...
            <p>
              <strong>5 out of 5</strong> users use alternative methods to share
              files when the upload size is too large
            </p>

            <h2>User Journey</h2>
            <p>
              The user opens the Discord app and select the file they'd like to
              send. Discord tells them their file is too large and cannot be
              sent through Discord. The user decides to leave Discord and
              compress the file or upload the file to an external app. They go
              back to Discord and select the file they want to send or paste the
              link to the external app.
            </p>
            <div className="ProjectImage--ProjectPage">
              <img
            ...
            <p>
              One of Slack's strengths is group collaboration. Facebook
              Messenger allows for cross-app communication, and Skype has a
              smart messaging feature.
            </p>
            <p>
              However, most of Slack's features are behind a paywall, Slack and
              Skype's chat history gets deleted after a certain point, and
              Facebook Messenger faces a lack of privacy as user messages are
              scanned.
            </p>
            <div className="ProjectImage--ProjectPage">
              <img
            ...
            <h2>Takeaways</h2>
            <p>
              People use Discord for the same reasons - communicating with
              friends
            </p>
            <p>
              Users have similar issues with Discord. They are unhappy with the
              upload limit and often have to resort to workarounds.
            </p>
            <p>
              Unlike its competitors, Discord does not require a subscription to
              access most features. Message history is always available, and
              users can easily find old messages with search options.
            </p>
          </div>
          <div className="ProjectDiv ProjectResearchSynthesis">
            <div className="ProjectPageSubtitle">Solutions</div>
            <h2>
              Based on my research and observations, I identified three
              potential solutions to address the problem:
            </h2>
            <p>
              Google Drive integration would allow users to send files located
              on their Drive without having to leave the Discord app
            </p>
            <p>
              Getting rid of the Nitro service can lead to an increased file
              size, but Discord loses out on a revenue source
            </p>
            <p>
              Implement an in-app compression feature that allows users to
              compress large files without having to leave the app
            </p>
            <h2 className="quote">
              I decided to continue with the last solution. Offering a flexible
              file-sharing option would give non-subscribers an alternative
          ...
          <div className="ProjectDiv ProjectLoFi">
            ...
            <p>
              If a file a user decides to upload is too large, they receive a
              warning and are given the option to compress or go back and select
              a different file.
            </p>
            <div className="ProjectImage--ProjectPage">
            ...
            <p>
              If a user wants to compress, they get to choose what percentage
              they'd like to compress the file by.
            </p>
            <div className="ProjectImage--ProjectPage">
              <img src={DiscordLoFi2} alt="Discord LoFi Screenshot 2" />
            </div>
            <p>
              On the compression confirmation screen, users can send their file
            ...
            <p>
              If the user chooses to send, they will see a progress bar that
              lets them know their file compression status.
            </p>
            <div className="ProjectImage--ProjectPage">
          ...
          <div className="ProjectDiv ProjectUserTesting">
            ...
            <h2>User Testing</h2>
            <p>
              During rounds of usability testing, I received the following
              feedback:
            </p>
            <p>
              Specify the final size of the file after compression. With only
              the percentage given, the file size is unknown.
            </p>
            <p>Make the text bigger. Some of the text is too small.</p>
            <p>
              Include onboarding screens where users can learn about the new
              process.
            </p>
          </div>
          <div className="ProjectDiv ProjectHiFi">
            ...
            <p>
              Incorporating feedback from the usability testing session, I
              modified the prototype. The working prototype can be seen below.
            </p>
          </div>
        </div>
        ...
        <div className="ProjectContent">
          <div className="ProjectDiv ProjectTakeaways">
            ...
            <h2 className="quote">
              A flexible file-sharing options is one of the many ways Discord
